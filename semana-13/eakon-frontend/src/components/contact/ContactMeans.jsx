      ...
      <div className="container g-elements g-elements--responsive-2 gap-lg">
        <div className="d-flex f-direction-column gap-sm">
          <h3 className="section__title section__title-sm">
            {attributes?.hero.titulo}
          </h3>
          <p className="section__text">{attributes?.descripcion}</p>
          <ul className="list d-flex f-direction-column gap-xs">
            <li>
              <h4 className="section__subtitle section__subtitle--xs">
                <BsGeoAlt /> Dirección
              </h4>
              <ul className="list">
                <li className="section__text section__text--sm">
                  {attributes?.componentes[0].direccion},{" "}
                  {attributes?.componentes[0].ciudad},{" "}
                  {attributes?.componentes[0].pais}
                </li>
              </ul>
            </li>
            <li>
              <h4 className="section__subtitle section__subtitle--xs">
                <BsClock /> Horario de atención
              </h4>
              <ul className="list">
                <li className="section__text section__text--sm">
                  {attributes?.componentes[4].dia},{" "}
                  {attributes?.componentes[4].hora_inicio},{" "}
                  {attributes?.componentes[4].hora_salida}
                </li>
                <li className="section__text section__text--sm">
                  {attributes?.componentes[5].dia},{" "}
                  {attributes?.componentes[5].hora_inicio},{" "}
                  {attributes?.componentes[5].hora_salida}
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list">
                <li className="section__text section__text--sm">
                  <a
                    href={`mailto:${attributes?.componentes[1].email_corporativo}`}
                ...
                <li className="section__text section__text--sm">
                  <a
                    href={`mailto:${attributes?.componentes[2].email_corporativo}`}
                    className="list__link"
                  >
        ...
        <div className="d-flex f-direction-column gap-sm">
          ...
          <form className="d-flex f-direction-column gap-xs">
            ...
            <textarea
              ...
              required
            ></textarea>
            <button className="button-lg button button--primary">
              Contactar
            </button>
          </form>
        </div>
